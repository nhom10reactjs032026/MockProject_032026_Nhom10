...
export const AdminLayout = () => {
  const sidebarItems = [
    { icon: <Users size={20} />, label: 'Notary Profile', path: '/admin/notaries' },
    { icon: <LayoutDashboard size={20} />, label: 'Dashboard', path: '/admin/dashboard' },
    { icon: <ClipboardList size={20} />, label: 'Jobs', path: '/admin/jobs' },
    { icon: <Calendar size={20} />, label: 'Scheduling', path: '/admin/calendar' },
    ...
    <div className="flex min-h-screen bg-[#f8fbff]">
      ...
      <aside className="w-64 bg-blue-600 text-white flex flex-col shadow-xl z-30">
        <div className="p-8 flex items-center gap-3">
          ...
          <span className="font-bold text-xl tracking-tight italic">NotaryApp</span>
        </div>
        ...
        <div className="p-6 mt-auto border-t border-white/10">
          <Button variant="ghost" className="w-full justify-start text-blue-100 hover:bg-white/10 hover:text-white gap-3 px-4 h-12 rounded-xl">
            <LogOut size={20} />
            <span>Logout</span>
          </Button>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-20">
          <div className="flex items-center gap-2">
             ...
             <span className="text-slate-800 font-bold">Notary Profile Management</span>
          </div>
          
          <div className="flex items-center gap-6">
            <Button variant="ghost" size="icon" className="relative text-gray-400 hover:text-blue-600 hover:bg-blue-50">
              <Bell size={20} />
            ...
            <div className="flex items-center gap-3 pl-6 border-l border-gray-100">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-slate-800 leading-none">Duc Joey</p>
                <p className="text-[10px] font-bold text-slate-400 uppercase mt-1">Admin</p>
              </div>
