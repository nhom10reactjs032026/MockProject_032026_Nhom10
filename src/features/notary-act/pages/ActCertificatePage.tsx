        ...
        <>
            <div className="animate-in fade-in duration-500 bg-[#f8fbff]/30 min-h-screen pb-12">
                <div className="max-w-[1400px] mx-auto py-8">
                    ...
                    {/* Main content */}
                    <div className="px-8">
                        <div className="text-2xl font-bold text-gray-900 mb-6">Notarial Certificate and Seal</div>
                        <div className="border border-gray-200 rounded-2xl p-6 bg-white shadow-sm space-y-8">
                            {/* Certificate Template */}
                            <div>
                                <h2 className="text-base font-bold text-gray-900 tracking-wide mb-4">Certificate Template</h2>
                                <div className="grid grid-cols-2 gap-6 w-full">
                                    <div>
                                        <label className="block text-[11px] font-bold text-gray-500  tracking-widest mb-1.5">Act Type</label>
                                        <select
                                            value={selectedActType}
                                            onChange={(e) => setSelectedActType(e.target.value)}
                                            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
                                        >
                                    ...
                                    <div>
                                        <label className="block text-[11px] font-bold text-gray-500  tracking-widest mb-1.5">State</label>
                                        <select
                                            value={selectedState}
                                ...
                                <div className="mt-3 p-3 bg-blue-50/60 rounded-lg text-xs text-blue-700 border border-blue-100">
                            ...
                            {/* Editable Fields */}
                            <div>
                                <h2 className="text-base font-bold text-gray-900 tracking-wide mb-4">Editable Fields</h2>
                                <div className="grid grid-cols-2 gap-6">
                                    {/* Venue */}
                                    <div>
                                        <label className="block text-[11px] font-bold text-gray-500 tracking-widest mb-1.5">Venue</label>
                                        {isEditingVenue ? (
                                            ...
                                            <div className="flex justify-between items-center group">
                                                <p className="text-sm font-medium text-gray-900 bg-gray-50 px-4 py-3 rounded-xl w-full border border-gray-200">{venue}</p>
                                                <button
                                    ...
                                    {/* Date */}
                                    <div>
                                        <label className="block text-[11px] font-bold text-gray-500 tracking-widest mb-1.5">Date</label>
                                        {isEditingDate ? (
                                            <div className="flex gap-2">
                                                <input
                                                    type="date"
                                            ...
                                            <div className="flex justify-between items-center group">
                                                <p className="text-sm font-medium text-gray-900 bg-gray-50 px-4 py-3 rounded-xl w-full border border-gray-200">{date}</p>
                                                <button
                                ...
                                {/* Names of Signers */}
                                <div className="mt-6">
                                    <label className="block text-[11px] font-bold text-gray-500 tracking-widest mb-1.5">Names of Signers</label>
                                    <div className="border border-gray-200 rounded-xl bg-gray-50 px-4 py-3 transition-all hover:bg-gray-100/70">
                                        <p className="text-sm font-medium text-gray-900">{signers.join(', ')}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Seal Application */}
                            <div>
                                <h2 className="text-base font-bold text-gray-900 tracking-wide mb-4">Seal Application</h2>
                                <div className="space-y-4">
                                    <div className="">
                                        <label className="flex items-center gap-2 cursor-pointer group">
                                            <input
                                                type="radio"
                                                name="sealType"
                                                checked={sealType === 'physical'}
                                                onChange={() => setSealType('physical')}
                                        ...
                                        <label className="flex items-center gap-2 cursor-pointer group">
                                            <input
                                                type="radio"
                                                name="sealType"
                                                checked={sealType === 'electronic'}
                                                onChange={() => setSealType('electronic')}
                                                className="hidden peer"
                                            />
                                            <div className="w-4 h-4 rounded-full border border-gray-300 peer-checked:bg-blue-500 peer-checked:border-blue-500 transition-all" />
                                    ...
                                    <div className="mt-4 p-15 border-2 border-gray-300 rounded-xl bg-gray-50 flex flex-col items-center justify-center space-y-4">
                                        <p className="text-xs font-medium text-gray-500 tracking-wider">SEAL PLACEMENT AREA PLACEHOLDER</p>
                                        <div className="w-56 h-24 border-2 border-dashed border-gray-400 rounded-lg bg-white flex items-center justify-center">
                                            <span className="text-sm font-bold text-gray-600">NOTARY SEAL</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Preview */}
                            <div>
                                <h2 className="text-base font-bold text-gray-900 tracking-wide mb-4">Preview</h2>
                                <div className="border border-gray-200 rounded-xl p-6 bg-gray-50 min-h-[200px] flex items-center justify-center text-gray-400 text-sm">
                                    Preview will be available after finalization
                                </div>
                            </div>
