              ...
              <div className="w-full lg:w-2/3">
                <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm">
                  <h2 className="text-lg font-bold text-gray-900 mb-8">
                    Identity Verification for {signerName}
                  </h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-2">
                      ...
                      <div className="space-y-3">
                        ...
                        >
                          <div
                            className={`w-4 h-4 rounded-full border flex items-center justify-center transition-colors ${verificationMethod === "physical" ? "border-blue-600" : "border-gray-300"}`}
                          >
                          ...
                          <span
                            className={`text-sm ${verificationMethod === "physical" ? "font-medium text-gray-900" : "text-gray-600"}`}
                          >
                            Physical Presence
                          </span>
                        </label>
                        ...
                        >
                          <div
                            className={`w-4 h-4 rounded-full border flex items-center justify-center transition-colors ${verificationMethod === "ron" ? "border-blue-600" : "border-gray-300"}`}
                          >
                          ...
                          <span
                            className={`text-sm ${verificationMethod === "ron" ? "font-medium text-gray-900" : "text-gray-600"}`}
                          >
                            Remote Online Notarization (KBA + ID Scan)
                          </span>
                        </label>
                      </div>
                    </div>
                        ...
                        {uploadedFile ? (
                          ...
                          <>
                            ...
                            <p className="text-sm font-medium text-gray-500">
                              Drag and drop ID images here, or{" "}
