...
export const ActExecutionPage = () => {
  ...
  const participant2 =
    act?.clientType.replace("For: ", "").trim() || "Jhon Doe";
          ...
          <div className="px-8 max-w-4xl mx-auto space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Confirm physical presence of principal.
                    </p>
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        >
                          <div
                            className={`w-4 h-4 bg-white rounded-full shadow-sm absolute transition-all ${isVerified ? "right-1" : "left-1"}`}
                          ></div>
                        </div>
                        <span
                          className={`text-sm font-bold ${isVerified ? "text-violet-700" : "text-gray-500"}`}
                        >
                    ...
                    <label className="h-32 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-gray-100 transition-colors relative block w-full">
                        ...
                        onChange={(e) => {
                          if (e.target.files && e.target.files[0]) {
                            setSignatures((prev) => ({
                              ...
                              signer1: {
                                ...prev.signer1,
                                wetSignature: e.target.files![0].name,
                              },
                            }));
                          }
                        }}
                      ...
                      {signatures.signer1.wetSignature ? (
                        <div className="flex flex-col items-center p-2">
                          ...
                          <p
                            className="text-[10px] font-bold text-blue-600 hover:text-blue-800 uppercase tracking-widest mt-2"
                            onClick={(e) => {
                              e.preventDefault();
                              setSignatures((prev) => ({
                                ...prev,
                  ...
                  <div>
                      ...
                      <button
                        onClick={() =>
                          setSignatures((prev) => ({
                            ...
                            signer1: {
                              ...prev.signer1,
                              hasSignature: !prev.signer1.hasSignature,
                            },
                          }))
                        }
                    ...
                    <div className="h-32 border-2 border-gray-100 rounded-xl bg-white flex flex-col items-center justify-center relative overflow-hidden group hover:border-blue-200 transition-colors">
                      <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.03]">
                        <span className="font-black text-2xl -rotate-12 whitespace-nowrap">
                          NOTARY DIGITAL
                        </span>
                      </div>
                      ...
                      <button
                        onClick={() =>
                          setSignatures((prev) => ({
                            ...
                            signer2: {
                              ...prev.signer2,
                              hasSignature: !prev.signer2.hasSignature,
                            },
                          }))
                        }
                        className="text-[10px] font-bold text-blue-600 hover:text-blue-800 uppercase tracking-widest"
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-[11px] text-gray-500 mt-3 font-medium">
                Date and time will be locked upon completion of the act.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              ...
              <div className="mt-4 flex items-center gap-4 text-[10px] font-bold uppercase tracking-widest">
                <span className="text-gray-400 flex items-center gap-1.5">
                  <UploadCloud size={14} /> AUTO-SAVED
                </span>
                <span className="text-emerald-500 flex items-center gap-1.5">
                  <CheckCircle2 size={14} /> JOURNAL COMPLIANT
                </span>
              </div>
            </div>
            ...
            <div className="text-center pb-8 border-t border-gray-100 pt-6">
              ...
              <p className="text-[9px] font-bold text-gray-400 mt-2 tracking-wider">
                Session started: Oct 24, 2023 at 2:15 PM EST • Local Device Time
              </p>
            </div>
          </div>
        )}
