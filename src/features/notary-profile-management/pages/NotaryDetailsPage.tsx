...
import { Loader2, ArrowLeft, Mail, Phone, MapPin, Fingerprint, Ban } from 'lucide-react';
  ...
  if (isLoading) {
    return (
      <div className="h-[60vh] flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-slate-500 font-medium">Loading notary information...</p>
      </div>
    );
  }
    ...
    return (
      <div className="h-[60vh] flex flex-col items-center justify-center gap-6 text-center px-4">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-bold text-slate-800">Notary Not Found</h2>
          <p className="text-slate-500 max-w-md">We couldn't find the notary profile you're looking for.</p>
        </div>
    ...
    <div className="animate-in fade-in duration-500 bg-[#f8fbff]/30 min-h-screen">
      <div className="max-w-[1400px] mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 mb-6 text-[15px]">
          <Link to="/admin/notaries" className="text-slate-900 font-bold hover:text-blue-600 transition-colors">
            Notary Profile
          </Link>
          <span className="text-slate-300">/</span>
          <span className="text-slate-500 font-medium">{notary.firstName} {notary.lastName}</span>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm mb-8 relative">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
            <div className="flex items-center gap-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 flex-wrap">
                   <h1 className="text-[32px] font-bold text-slate-900 tracking-tight">{notary.firstName} {notary.lastName}</h1>
            ...
            <div className="w-full lg:w-auto self-start pt-2">
              <Button variant="outline" className="text-rose-400 border-rose-100 hover:bg-rose-50 hover:text-rose-500 rounded-2xl px-8 h-12 flex items-center gap-3 font-bold border-2 transition-all">
                <Ban size={18} />
                Deactive
              </Button>
            </div>
