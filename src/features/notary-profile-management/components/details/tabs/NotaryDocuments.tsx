...
/**
 * Component for managing general notary documents.
 * Includes search, filtering by status/type, and pagination UI.
 */
  ...
  const documents = [
    {
      id: "#8829",
      type: "Commission",
      fileName: "commission_cert_2022.pdf",
      date: "2022-06-03",
      size: "1.2M",
      status: "Verified",
    },
    ...
    },
    {
      id: "#8827",
      type: "RON",
      fileName: "ron_certification.pdf",
      date: "2023-01-03",
      size: "3M",
      status: "Verified",
    },
    {
      id: "#8826",
      type: "Training",
      fileName: "advanced_training.pdf",
      date: "2023-01-04",
      size: "4M",
      status: "Pending",
    },
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-700">
      ...
      <div className="rounded-3xl border border-gray-100 bg-white shadow-sm overflow-hidden">
        {filteredDocuments.length > 0 ? (
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50/70 h-14 border-b border-gray-100 text-nowrap">
            ...
            <TableBody>
              {filteredDocuments.map((doc) => (
                <TableRow
                  key={doc.id}
                  className="hover:bg-slate-50/50 h-20 border-b border-gray-50 last:border-0 transition-colors"
                >
          ...
          /* Empty State for Failed Search Results */
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-[13px] text-slate-400 font-medium mt-4 pb-10">
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
            size="icon"
            className="h-9 w-9 rounded-xl border border-gray-100 bg-white shadow-sm"
          >
            <ChevronLeft size={18} />
          </Button>
